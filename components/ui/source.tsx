  ...
  return (
    <HoverCardTrigger asChild>
      <a
        ...
        className={cn(
          "hover:bg-muted-foreground/30 hover:text-primary inline-flex h-[1.25rem] max-w-32 items-center gap-1 overflow-hidden rounded-full bg-muted py-0 text-[12px] leading-none text-muted-foreground no-underline transition-colors duration-150",
      ...
      >
        ...
        <span className="truncate text-center text-[12px] font-normal tabular-nums">{labelToShow}</span>
      </a>
    </HoverCardTrigger>
  )
}
